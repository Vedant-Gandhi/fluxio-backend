...
type Video struct {
	...
	CreatedAt       int64      `gorm:"autoCreateTime:nano" json:"created_at"`
	UpdatedAt       int64      `gorm:"autoUpdateTime:nano" json:"updated_at"`
	DeletedAt       *int64     `gorm:"index" json:"deleted_at,omitempty"` // Should be nullable
